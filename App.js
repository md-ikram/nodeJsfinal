...
const Blog=require('./modes/blog')
const BlogRouts=require('./routes/blogsRoutes')
//express app
const app=express()

const dbURI='mongodb+srv://netninja:test1234:<username>:<password>@nodetuts-del96.mongodb.net/test? retreWrites=true&=majority:'
mongoose.connet(dbURI,{useNewUrlParsar:true, useUnifiedtopology:true})
